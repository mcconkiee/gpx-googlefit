...
module.exports = {
    ...
    upload: function(filepath, upload_callback) {
        ...
        var activityNameFromFile = "Fit Import"
        importer.setup(function() {
            async.waterfall([
                    //---------> PARSE THE GPX
                    function(callback) {
                        gpxParse.parseGpxFromFile(filepath, function(error, data) {
                            ...
                            if (data.tracks) {
                                data.tracks.forEach(function(track) {
                                    ...
                                    activityNameFromFile = trackName;
                                    var isRun = (trackName.indexOf("Running") >= 0 || trackName.indexOf("Run") >= 0);
                                    var isTrainer = (trackName.indexOf("Trainer") >= 0);
                                    ...
                                    if (trackName) {                                        
                                        if (isRun) {                                                                                        
                                            ...
                                            currentActivityType = CURRENT_ACTIVITY_TYPE.TRAINER;                                            
                                        }else if (isMtnRide) {                                            
                    ...
                    function(dataSourceResource, callback) {
                        var sessionData = {
                            ...
                            "name": (activityNameFromFile) ? activityNameFromFile : "Fit Import",
                    ...
                    function(dataSourceResource, callback) {
                        ...
                        switch(currentActivityType){
                            ...
                            MET = 6.0;
                            break;
                            case CURRENT_ACTIVITY_TYPE.TRAINER:
                            MET = 5.5;
                            break;
                            default:
                            MET = 8.0;
                        ...
                        sails.log.info(activityNameFromFile," uploaded. Start time =  ",startNano," | End time = ",endNano," |  mins(length): ",minsWorkingOut," of activity type = ",currentActivityType)    
